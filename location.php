...
<h1>Add Student</h1>
	...
	<form name="AddForm" action="location.php"  method="post">
		...
		<p><input type="submit" name="add" value="Add"></input></p>
	</form>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	if (isset($_POST['add'])) 
		{
			$insert_query = "INSERT INTO Student_Location (StudentID, UserName, UserSurname, Location, Date) VALUES (?, ?, ?, ?, ?)";
			$params = array($_POST['StudentID'],$_POST['UserName'],$_POST['UserSurname'],$_POST['Location'], $dateTime);
